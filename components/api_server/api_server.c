...
"<nav class=nav><button data-p=dash onclick=\"show('dash')\">Status</button><button data-p=manual onclick=\"show('manual')\">Manual</button><button data-p=schedule onclick=\"show('schedule')\">Schedule</button><button data-p=weather onclick=\"show('weather')\">Weather</button><button data-p=sensor onclick=\"show('sensor')\">Sensors</button><button data-p=history onclick=\"show('history')\">History</button><button data-p=wifi onclick=\"show('wifi')\">Wi-Fi</button><button data-p=console onclick=\"show('console')\">Console</button></nav><div id=notice class=notice></div>"
"<section id=dash></section><section id=manual hidden></section><section id=schedule hidden></section><section id=weather hidden></section><section id=sensor hidden></section><section id=history hidden></section><section id=wifi hidden></section><section id=console hidden></section></main>"
